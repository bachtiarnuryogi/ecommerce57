          ...
          <div class="col-lg-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="<?php echo base_url('Admin/converse')?>" class="btn btn-primary">Lihat</a>
              </div>
            </div>
            <div class="card card-primary card-outline">
              <div class="card-header">
              ...
              <div class="card-body">
                ...
                <a href="<?php echo base_url('Admin/running')?>" class="btn btn-primary">Lihat</a>
              </div>
            </div>
            <div class="card card-primary card-outline">
              <div class="card-header">
              ...
              <div class="card-body">
                ...
                <a href="<?php echo base_url('Admin/boots')?>" class="btn btn-primary">Lihat</a>
              </div>
            </div>
          </div>
          <!-- /.col-md-6 -->
