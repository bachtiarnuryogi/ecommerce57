            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="<?php echo base_url('Customer/register')?>" class="signup-image-link">Create an account</a>
                    </div>

                    <div class="signin-form">
                        <h2 class="form-title">Sign up</h2>
                        <form action="<?php echo base_url('Customer/login/aksi_login'); ?>" method="POST" class="register-form" id="login-form">
