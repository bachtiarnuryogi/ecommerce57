    ...
    foreach ($produk as $row) { ?>
            <div class="col-lg-4 col-md-6 mb-4">
              ...
              <form method="post" action="<?php echo base_url();?>Customer/shopping/tambah" method="post" accept-charset="utf-8" >	 
                <a href="#"><img class="img-thumbnail" src="<?php echo base_url() . 'gambar/product/'.$row['gambar']; ?>"/></a>
                <div class="card-body">
                  <h4 class="card-title">
                    <a href="#"><?php echo $row['nama_produk'];?></a>	 
                  </h4>	 	
                  <h5>Rp. <?php echo number_format($row['harga'],0,",",".");?>< /h 5>
                  <p class="card-text"><?php echo $row['deskripsi'];?>< /p >	 
                </div>	 	
                <div class="card-footer">
                  <a href="<?php echo base_url();?>Customer/shopping/detail_produk/<?php echo $row['id_produk'];?>" class="btn btn-sm btn-default">
